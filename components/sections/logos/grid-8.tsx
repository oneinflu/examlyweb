  ...
  return (
    <Section>
      <div className="mx-auto flex max-w-container flex-col items-center gap-8 text-center">
        ...
        <div className="relative grid w-full auto-rows-fr grid-cols-2 gap-[1px] bg-border text-center md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="hidden aspect-[2/1] bg-background md:flex lg:hidden" />
        </div>
      </div>
    </Section>
  );
