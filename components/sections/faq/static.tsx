...
export default function FAQ() {
  return (
    <Section>
      <div className="mx-auto flex max-w-container flex-col items-center gap-8 md:flex-row md:items-start">
        <h2 className="max-w-[480px] text-center text-3xl font-semibold leading-tight sm:text-5xl md:text-left md:leading-tight">
        ...
        <div className="flex flex-col gap-4 py-6">
          ...
          <article className="flex flex-col gap-2">
            <h3 className="text-lg font-semibold">Are Figma files included?</h3>
            <p className="mb-4 max-w-[580px] text-muted-foreground">
          ...
          <article className="flex flex-col gap-2">
            <h3 className="text-lg font-semibold">Can I get a discount?</h3>
            <p className="mb-4 max-w-[580px] text-muted-foreground">
              Actually, yes! I&apos;m looking for beta testers and great
              examples of Launch UI in action to feature on the website.
              Here&apos;s the deal: you provide feedback to help me improve the
              product, and in return, you get a huge discount plus a solid
