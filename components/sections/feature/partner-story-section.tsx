        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight text-foreground">
              From Fragmented Tools to <span className="text-primary">Streamlined Management</span>
            </h2>
            ...
            <div className="relative p-6 bg-muted/20 rounded-xl border border-border/50">
              ...
              <p className="text-lg text-foreground/90 italic">
                &quot;Before Examly, juggling schedules, homework, and payments was overwhelming. Now everything flows effortlessly.&quot;
              </p>
              <div className="mt-4 flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-foreground">Partner Coach</p>
                  <p className="text-xs text-muted-foreground">Examly Education Partner</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                {[
                  { icon: <Calendar className="h-5 w-5 text-primary" />, text: "Effortless scheduling and calendar management" },
                  { icon: <FileText className="h-5 w-5 text-primary" />, text: "Streamlined homework assignment and tracking" },
                  { icon: <Calculator className="h-5 w-5 text-primary" />, text: "Simplified payment processing and invoicing" },
                  { icon: <Users className="h-5 w-5 text-primary" />, text: "Centralized student management and progress tracking" }
                ].map((item, index) => (
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-background/80 to-background/30 backdrop-blur-sm rounded-xl border border-border/50 p-6">
              ...
              <div className="relative h-full w-full">
                ...
                <Card className={`absolute top-6 right-6 w-[120px] h-[120px] p-4 flex flex-col items-center justify-center shadow-lg transition-all duration-500 ${isHovered ? 'opacity-50 scale-90 translate-x-[-100px] translate-y-[100px]' : ''}`}>
                  ...
                  <p className="text-xs font-medium text-center">Payments</p>
                </Card>
                ...
                <Card className={`absolute bottom-6 left-6 w-[120px] h-[120px] p-4 flex flex-col items-center justify-center shadow-lg transition-all duration-500 ${isHovered ? 'opacity-50 scale-90 translate-x-[100px] translate-y-[-100px]' : ''}`}>
                  ...
                  <p className="text-xs font-medium text-center">Homework</p>
                </Card>
